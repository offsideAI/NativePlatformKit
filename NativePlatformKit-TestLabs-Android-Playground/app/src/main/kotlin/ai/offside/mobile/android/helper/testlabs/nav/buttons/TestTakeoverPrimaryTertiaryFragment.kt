...
import ai.offside.mobile.android.helper.testlabs.databinding.FragmentTestTakeoverWithStickyButtonsVerticalTertiaryBinding

class TestTakeoverPrimaryTertiaryFragment: DialogFragment() {

    private lateinit var binding: FragmentTestTakeoverWithStickyButtonsVerticalTertiaryBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTestTakeoverWithStickyButtonsVerticalTertiaryBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.stickyButtonsContainer.secondaryButton.setOnClickListener {
            Toast.makeText(context, "Tertiary Button Clicked", Toast.LENGTH_SHORT).show()
        }
